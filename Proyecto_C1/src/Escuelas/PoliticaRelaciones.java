 ...
 * @author USUARIO
 */
public class PoliticaRelaciones extends AbstractFactory {

    private ArrayList<AbstractProfesores> profesores = null;
    private ArrayList<AbstractEstudiantes> estudiantes = null;

    @Override
    public Decano.PoliticaRelaciones getDecano() {
        Decano.PoliticaRelaciones decano = new Decano.PoliticaRelaciones();
    ...
    public ArrayList<AbstractProfesores> getProfesores(int i) {
        ...
        for (int j = 0; j < i; j++) {
            profesores.add(new Profesores.PoliticaRelaciones());
        }
        return profesores;
    }
    ...
    public ArrayList<AbstractEstudiantes> getEstudiantes(int i) {
        ...
        for (int j = 0; j < i; j++) {
            estudiantes.add(new Estudiantes.PoliticaRelaciones());
        }
        return estudiantes;
    }
