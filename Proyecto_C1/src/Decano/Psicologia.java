 ...
 * @author USUARIO
 */
public class Psicologia extends AbstractDecano {

    @Override
    public String QuienSoy() {
        return "Soy el decano de la Escuela de Psicologia";
    }
    ...
    public void ingresarProfesores(){
        AbstractProfesores profe = new Profesores.Psicologia();
        AbstractProfesores profe2 = new Profesores.Psicologia();
