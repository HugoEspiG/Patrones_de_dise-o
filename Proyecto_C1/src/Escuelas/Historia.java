 ...
 * @author USUARIO
 */
public class Historia extends AbstractFactory {

    private ArrayList<AbstractProfesores> profesores = null;
    private ArrayList<AbstractEstudiantes> estudiantes = null;

    @Override
    public Decano.Historia getDecano() {
        Decano.Historia decano = new Decano.Historia();
    ...
    public ArrayList<AbstractProfesores> getProfesores(int i) {
        ...
        for (int j = 0; j < i; j++) {
            profesores.add(new Profesores.Historia());
        }
        return profesores;
    }
    ...
    public ArrayList<AbstractEstudiantes> getEstudiantes(int i) {
        ...
        for (int j = 0; j < i; j++) {
            estudiantes.add(new Estudiantes.Historia());
        }
        return estudiantes;
    }
