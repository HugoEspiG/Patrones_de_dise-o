 ...
 * @author USUARIO
 */
public class Psicologia extends AbstractFactory {

    private ArrayList<AbstractProfesores> profesores = null;
    private ArrayList<AbstractEstudiantes> estudiantes = null;

    @Override
    public Decano.Psicologia getDecano() {
        Decano.Psicologia decano = new Decano.Psicologia();
    ...
    public ArrayList<AbstractProfesores> getProfesores(int i) {
        ...
        for (int j = 0; j < i; j++) {
            profesores.add(new Profesores.Psicologia());
        }
        return profesores;
    }
    ...
    public ArrayList<AbstractEstudiantes> getEstudiantes(int i) {
        ...
        for (int j = 0; j < i; j++) {
            estudiantes.add(new Estudiantes.Psicologia());
        }
        return estudiantes;
    }
