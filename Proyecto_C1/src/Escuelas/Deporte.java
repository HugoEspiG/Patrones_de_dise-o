 ...
 * @author USUARIO
 */
public class Deporte extends AbstractFactory {

    private ArrayList<AbstractProfesores> profesores = null;
    private ArrayList<AbstractEstudiantes> estudiantes = null;

    @Override
    public Decano.Deporte getDecano() {
        Decano.Deporte decano = new Decano.Deporte();
    ...
    public ArrayList<AbstractProfesores> getProfesores(int i) {
        ...
        for (int j = 0; j < i; j++) {
            profesores.add(new Profesores.Deporte());
        }
        return profesores;
    }
    ...
    public ArrayList<AbstractEstudiantes> getEstudiantes(int i) {
        ...
        for (int j = 0; j < i; j++) {
            estudiantes.add(new Estudiantes.Deporte());
        }
        return estudiantes;
    }
