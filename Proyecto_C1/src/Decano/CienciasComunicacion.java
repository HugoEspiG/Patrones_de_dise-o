 ...
 * @author Labing
 */
public class CienciasComunicacion extends AbstractDecano{

    @Override
    public String QuienSoy() {
        return "Soy el decano de la Escuela de Ciencias de la Comunicacion";
    }
    ...
    public void ingresarProfesores(){
        AbstractProfesores profe = new Profesores.CienciasComunicacion();
        AbstractProfesores profe2 = new Profesores.CienciasComunicacion();
