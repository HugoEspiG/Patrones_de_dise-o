 ...
 * @author USUARIO
 */
public class FilosofiaHumanidades extends AbstractDecano {

    @Override
    public String QuienSoy() {
        return "Soy el decano de la Escuela de Filosofia y Humanidades";
    }
    ...
    public void ingresarProfesores(){
        AbstractProfesores profe = new Profesores.FilosofiaHumanidades();
        AbstractProfesores profe2 = new Profesores.FilosofiaHumanidades();
