 ...
 * @author Labing
 */
public class CienciasExactas extends AbstractFactory {

    private ArrayList<AbstractProfesores> profesores = null;
    private ArrayList<AbstractEstudiantes> estudiantes = null;

    @Override
    public Decano.CienciasExactas getDecano() {
        Decano.CienciasExactas decano = new Decano.CienciasExactas();
    ...
    public ArrayList<AbstractProfesores> getProfesores(int i) {
        ...
        for (int j = 0; j < i; j++) {
            profesores.add(new Profesores.CienciasExactas());
        }
        return profesores;
    }
    ...
    public ArrayList<AbstractEstudiantes> getEstudiantes(int i) {
        ...
        for (int j = 0; j < i; j++) {
            estudiantes.add(new Estudiantes.CienciasExactas());
        }
        return estudiantes;
    }
